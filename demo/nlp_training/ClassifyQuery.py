...
TF_MODEL_EXPORT_PATH = os.getenv("TF_MODEL_EXPORT_PATH", "./model_trail")
TF_MODEL_EXPORT_FILE = os.getenv("TF_MODEL_EXPORT_FILE","saved_model.pb")
...
def get_tf_record(sentence):
    words = open(BOWORDS_PATH +'/'+BOWORDS_FILE, 'r') 
